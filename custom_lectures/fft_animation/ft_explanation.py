...
class FourierTransformInternals(Scene):
    ...
    def construct(self):
        ...
        sin_wave_radial_graph_static_2 = complex_plane.plot_polar_graph(lambda x: sin_wave_func(x / (2 * 2 * PI)), theta_range=theta_range * 2, color=first_wave_color)
        self.remove(sin_wave_radial_graph_adjustable)
        self.add(sin_wave_radial_graph_static_2)
        ...
        self.wait(1)
        self.remove(sin_wave_radial_graph_static_2)
        self.add(sin_wave_radial_graph_adjustable)
